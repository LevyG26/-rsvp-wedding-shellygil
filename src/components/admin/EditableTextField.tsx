  ...
  return (
    <form onSubmit={handleSubmit} className="flex items-center gap-1.5" dir="ltr">
      <input
        ...
        className="w-full min-w-0 rounded-xl border border-gray-300 bg-white px-2 py-1.5 text-sm text-gray-900 outline-none focus:border-gray-500 focus:ring-2 focus:ring-gray-200 disabled:cursor-not-allowed disabled:bg-gray-100 dark:border-slate-600 dark:bg-slate-800 dark:text-slate-100 dark:focus:border-slate-400 dark:focus:ring-slate-700 dark:disabled:bg-slate-800 dark:disabled:text-slate-600"
      />
      {(hasChanged || isSaving) && (
        <button
          type="submit"
